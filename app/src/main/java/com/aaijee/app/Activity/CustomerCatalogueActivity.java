...
import com.aaijee.app.Fragment.CategoryFragmentCustomer;
...
public class CustomerCatalogueActivity extends AppCompatActivity {
   ...
   // private String cat_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_catalogue);
       ...
       // selectPosition = 41;
        ...
        tab = (TabLayout) findViewById(R.id.tabsCustomer);
        progress=findViewById(R.id.progresbar_rest_customer);
        txtNoData=findViewById(R.id.txtNoData_customer);
        cart_lay=findViewById(R.id.cart_lay_customer);
        loader=findViewById(R.id.loader_customer);
    ...
    private void getCategory()
    {
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(CustomerCatalogueActivity.this);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        for(int i=0;i<categoryLists.size();i++) {
            CategoryFragmentCustomer categoryFragmentCustomer = new CategoryFragmentCustomer();
            Bundle bundle = new Bundle();
            bundle.putString("id",categoryLists.get(i).getId());
            bundle.putString("category_name",categoryLists.get(i).getCategory_name());
            categoryFragmentCustomer.setArguments(bundle);
            adapter.addFragment(categoryFragmentCustomer, categoryLists.get(i).getCategory_name());
