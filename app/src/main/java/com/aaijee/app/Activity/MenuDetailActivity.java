...
public class MenuDetailActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_detail_demo);
...
//        scroll_lay.setVisibility(View.GONE);
        ...
        // Toast.makeText(MenuDetailActivity.this, ""+get_qty, Toast.LENGTH_SHORT).show();

//        if(get_qty.equals("0") || get_qty.equals(" "))
//        {
//
//
//        }
...
//                count.setText(qty);
                ...
                if (discount.equalsIgnoreCase("0")) {
                    ...
                    tvDiscount.setText(SharedPref.getCurrency(MenuDetailActivity.this) + price);
                    tvDiscount.setPaintFlags(tvPrice.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
                    tvPrice.setText(SharedPref.getCurrency(MenuDetailActivity.this) + disc_price);
...
////                            String[] splited = tvPrice.getText().toString().split(Method.escapeSpecialRegexChars(SharedPref.getCurrency(MenuDetailActivity.this)));
////                            try {
...
//                        e.printStackTrace();
//                    }
//                    addtocart(cat_id, id, name, image,variantLists.get(var_pos).getId(),variantLists.get(var_pos).getVolume(),final_price,variantLists.get(var_pos).getVolume_qty(), Constants.DECREMENT);
//                }
//            }
//        });
...
//                         }
                        ...
                        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(MenuDetailActivity.this, android.R.layout.simple_spinner_item, variant_list);
