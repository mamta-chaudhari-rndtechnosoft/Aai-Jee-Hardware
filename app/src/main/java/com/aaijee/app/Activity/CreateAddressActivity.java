...
public class CreateAddressActivity extends AppCompatActivity {
    ...
    private EditText edtname,edtmbl,edtemail,edtFlat,edtBuilding,edtlandmark,edtcity,edtbillAdd,edtpincode,edtGstNo;
    private String type;
    private String id,user_id,flat_no,building_name,landmark,city,pincode,name,email,mbl,address_type,area_name,gst,bill_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras == null) {
            ...
            if (type.equals("edit"))
            {
                ...
                bill_address=extras.getString("bill_address");
            }
        }
...
//        }
        ...
        edtbillAdd=findViewById(R.id.edtBillingAdd);
       // txthome=findViewById(R.id.txthome);
        ...
        if (type!=null && type.equals("edit"))
        {
            ...
            edtbillAdd.setText(bill_address);
...
//        });
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String bill_address=edtbillAdd.getText().toString();
                if (!checkFullname()) {
                    ...
                    Toast.makeText(CreateAddressActivity.this, "Please Select Area", Toast.LENGTH_SHORT).show();
                }
//                else if(gst.equalsIgnoreCase(""))
//                {
//                    Toast.makeText(CreateAddressActivity.this, "Please Enter GST No", Toast.LENGTH_SHORT).show();
//                }
                else
                {
                    newAddress(name, mbl, email, gst,flat, building, landmark, city, pincode,bill_address);
    ...
    public void newAddress(String name, String mbl, String email,String gst ,String flat, String building, String landmark, String city, String pincode ,String bill_address) {
        progress.setVisibility(View.VISIBLE);
        if (type!=null && type.equals("edit")) {
            params = "&id=" + id + "&user_id=" + SharedPref.getUserId(CreateAddressActivity.this) + "&area=" + area_id + "&flat_no=" + flat + "&building_name=" + building + "&landmark=" + landmark + "&city=" + city + "&pincode=" + pincode + "&name=" + name + "&email=" + email + "&mobile=" + mbl + "&address_type=" + address_type +"&gst="+ gst +"&bill_address="+bill_address;
            url= Constants.edit_address;
        }
        else {
            params = "&user_id=" + SharedPref.getUserId(CreateAddressActivity.this) + "&area=" + area_id + "&flat_no=" + flat + "&building_name=" + building + "&landmark=" + landmark + "&city=" + city + "&pincode=" + pincode + "&name=" + name + "&email=" + email + "&mobile=" + mbl + "&address_type=" + address_type +"&gst="+ gst+"&bill_address="+bill_address;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (error.equals("false")) {
                        ...
                        String bill_address=jsonObject1.getString("bill_address");

                        //Toast.makeText(CreateAddressActivity.this, ""+gst, Toast.LENGTH_SHORT).show();
                        ...
                        address.setGst(gst);
                        address.setBill_address(bill_address);
                        progress.setVisibility(View.GONE);
