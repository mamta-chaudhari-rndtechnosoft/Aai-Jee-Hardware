...
public class SearchMenuAdapter extends RecyclerView.Adapter<SearchMenuAdapter.ViewHolder> {
    ...
    public SearchMenuAdapter(Activity activity, List<MenuList> menuLists) {
        this.activity = activity;
        this.menuLists = menuLists;
    }

    @Override
    public SearchMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.new_menu_item, parent, false);
        return new SearchMenuAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final SearchMenuAdapter.ViewHolder holder, final int position) {

        final String[] price = {""};
        final int[] var_pos = {0};
        Glide.with(activity).load(menuLists.get(position).getImage()).thumbnail(Glide.with(activity).load(R.drawable.loading)).centerCrop().into(holder.imgMenu);
       ...
       // holder.linearLayout.setBackground(gd);
        ...
        holder.spinner_variant.setVisibility(View.GONE);
...
////                            addtocart(menuLists.get(position).getCat_id(),menuLists.get(position).getId(),menuLists.get(position).getName(),menuLists.get(position).getImage(),menuLists.get(position).getVariantLists().get(var_pos[0]).getId(),menuLists.get(position).getVariantLists().get(var_pos[0]).getVolume(),menuLists.get(position).getVariantLists().get(var_pos[0]).getPrice(),menuLists.get(position).getVariantLists().get(var_pos[0]).getVolume_qty(), Constants.INCREMENT);
////                        } else {
...
//        });
        ...
        if (menuLists.get(position).getDiscount().equalsIgnoreCase("0"))
        {
            ...
            holder.tvDiscount.setTextColor(activity.getResources().getColor(R.color.colorAccent));
            holder.tvPrice.setTextColor(activity.getResources().getColor(R.color.colorGrey1));
            holder.tvDiscountPrice.setVisibility(View.VISIBLE);
            holder.tvDiscount.setVisibility(View.VISIBLE);
            holder.tvDiscountPrice.setText(menuLists.get(position).getDiscount()+"%");
            double actual_price = Double.parseDouble(menuLists.get(position).getVariantLists().get(0).getPrice());
            ...
            holder.tvDiscount.setText(SharedPref.getCurrency(activity)+disc_price);
...
//                }
                   ...
                   addtocart(holder,menuLists.get(position).getCat_id(),menuLists.get(position).getId(),menuLists.get(position).getName(),menuLists.get(position).getImage(),menuLists.get(position).getVariantLists().get(var_pos[0]).getId(),menuLists.get(position).getVariantLists().get(var_pos[0]).getVolume(),menuLists.get(position).getVariantLists().get(var_pos[0]).getPrice(),menuLists.get(position).getVariantLists().get(var_pos[0]).getVolume_qty(), Constants.INCREMENT);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvName, tvDesc, tvPrice, tvQty,tvDiscountPrice,tvDiscount;
        ...
        public ViewHolder(View itemView)
        {
           ...
           // imgDesc = (ImageView) itemView.findViewById(R.id.imgDesc);
            ...
            tvDiscountPrice = (TextView) itemView.findViewById(R.id.tvDiscountPer);
