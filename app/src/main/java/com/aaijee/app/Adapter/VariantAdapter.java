...
public class VariantAdapter extends RecyclerView.Adapter<VariantAdapter.ViewHolder> {
    ...
    private void addtocart(final String cat_id, final String id, final String name, final String image, final String variant_id, final String volume, final String price, final String operation, final String flavour_Id, final String flavour_name) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.add_cart,
            ...
            public Map<String, String> getParams() {
                ...
                params.put("flavour", flavour_name);
