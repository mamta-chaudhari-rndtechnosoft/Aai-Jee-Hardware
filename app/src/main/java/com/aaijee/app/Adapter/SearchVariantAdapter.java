...
public class SearchVariantAdapter extends RecyclerView.Adapter<SearchVariantAdapter.ViewHolder> {
    ...
    public SearchVariantAdapter(Activity activity, MenuList menuList, ArrayList<VariantList> variantLists, LinearLayout sublayout, RecyclerView topping_recycler) {
    ...
    @Override
    public SearchVariantAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(activity).inflate(R.layout.menu_variant, parent, false);

        return new SearchVariantAdapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(final SearchVariantAdapter.ViewHolder holder, final int position) {
