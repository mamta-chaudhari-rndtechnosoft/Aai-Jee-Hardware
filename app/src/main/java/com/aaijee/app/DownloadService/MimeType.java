...
public class MimeType {
    ...
    public static String get(final String mimeType) {
        return mimeTypesExtensions.get(mimeType);
    }
    ...
    private static Map<String, String> createMap() {
        ...
        map.put("application/xapk-package-archive","xapk");
        ...
        putList(map, "gz",  "application/x-gzip");
        ...
        putList(map,"rar","application/x-rar-compressed","application/vnd.rar","application/x-rar");
        ...
        putList(map, "tgz", "application/gnutar");
