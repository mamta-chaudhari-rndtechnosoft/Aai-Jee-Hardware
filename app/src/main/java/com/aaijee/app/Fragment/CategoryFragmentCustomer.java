...
import com.aaijee.app.Activity.CustomerCatalogueActivity;
import com.aaijee.app.Adapter.CategoryMenuCustomerAdapter;
...
public class CategoryFragmentCustomer extends Fragment {
    ...
    CategoryMenuCustomerAdapter adapter;
    TextView tvNoData;
    ProgressBar progress_bar;
    LottieAnimationView loader,loaderMain;

    public CategoryFragmentCustomer() {
        // Required empty public constructor
    }


    public static CategoryFragmentCustomer newInstance(String position) {
        CategoryFragmentCustomer fragment = new CategoryFragmentCustomer();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView_menu=view.findViewById(R.id.recyclerView_menu_customer);
        tvNoData=view.findViewById(R.id.tvNoData_customer);
        progress_bar=view.findViewById(R.id.progresbar_menu_customer);
        loader = view.findViewById(R.id.loader_customer);
        loaderMain = view.findViewById(R.id.loaderMain_customer);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.menu_cat_wise+ cat_id +"&user_id="+ SharedPref.getUserId(getActivity()), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    //Toast.makeText(requireContext(), "catId: " + cat_id + " user: " +SharedPref.getUserId(getActivity()), Toast.LENGTH_SHORT).show();
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        for (int j = 0; j < arrayVariant.length(); j++) {
                            ...
                            String price = jsonObject.getString("mrp");
                            ...
                            for (int k = 0; k < arraySubMenu.length(); k++) {
                                ...
                                if (jsonObject1.getString("error").equals("False")) {
                                    ...
                                    String pricesub = jsonObject1.getString("mrp");
                    ...
                    if (menuLists.size()>0) {
                        adapter = new CategoryMenuCustomerAdapter(getActivity(), menuLists);
